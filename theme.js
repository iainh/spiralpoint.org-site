(() => {
  ...
  const mountSelector = () => {
    ...
    selector.setAttribute("aria-label", "Color scheme");
    selector.innerHTML = `
      <button type="button" data-theme-value="light" aria-label="Use light color scheme" title="Light">
      ...
      <button type="button" data-theme-value="dark" aria-label="Use dark color scheme" title="Dark">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
